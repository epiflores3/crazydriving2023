...
function openCreate() {
    ...
    fillSelect(CLIENTE_API, 'readAll', 'modelo');


    
    fillSelect(TELEFONO_API, 'getTipos', 'tipovehiculo');
}
...
async function openUpdate(id) {
    ...
    if (JSON.status) {
        ...
        fillSelect(TELEFONO_API, 'getTipos', 'tipovehiculo', JSON.dataset.tipo_vehiculo);
        fillSelect(CLIENTE_API, 'readAll', 'modelo', JSON.dataset.id_modelo);
        ;
    } else {
        sweetAlert(2, JSON.exception, false);
    }
