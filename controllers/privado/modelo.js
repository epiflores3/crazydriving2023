...
const SAVE_MODAL = new bootstrap.Modal(document.getElementById('agregarModelo'));
...
<tr>
    ...
    <td>
        ...
        <button type="button" class="btn " onclick="openUpdate(${row.id_modelo})">
            <img height="20px" width="20px" src="../../resource/img/imgtablas/update.png" alt="actualizar">
        </button>

        <button onclick="openDelete(${row.id_modelo})" class="btn"><img height="20px" width="20px"
