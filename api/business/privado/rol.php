<?php
require_once('../../entities/dto/rol.php');
    ...
    if (isset($_SESSION['id_usuario'])) {
        ...
        switch ($_GET['action']) {
            ...
            case 'searchR':
                ...
                } elseif ($result['dataset'] = $rol->searchRows($_POST['search-rol'])) {
                    $result['status'] = 1;
            ...
            case 'update':
                ...
                // } elseif (!$data = $rol->readOne()) {
                //     $result['exception'] = 'Rol inexistente';
                } elseif (!$rol->setRol($_POST['idrol'])) {
                    $result['exception'] = 'Rol incorrecto';
